...
export let role = "admin"; // Change this to "admin", "teacher", "student", or "parent" to test different roles
...
// Current Date for reference: April 23, 2025
// Shifting events to be visible around the current date.
