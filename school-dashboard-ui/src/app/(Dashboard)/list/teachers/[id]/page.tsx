...
const shortCutData = ["Teacher's Classes", "Teacher's Students", "Teacher's Lessons", "Teacher's Exams", "Teacher's Assignments" ]
  ...
  return (
    <div className='flex flex-col w-full md:flex-row gap-4'>
      ...
      <div className='w-full md:w-2/3 flex flex-col gap-2'>
        ...
        <h1 className='p-4 font-semibold'>Teacher's Schedule</h1>
            <BigCalender/>
        </div>
      </div>
